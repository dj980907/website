...
import { benefit1, benefit2, benefit3, check } from "../assets";
import { BanyanServices, BanyanServicesIcons } from "../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
  VideoChatMessage,
} from "./design/Benefits";
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {BanyanServicesIcons.map((item, index) => (
                    <li
                      key={index}
